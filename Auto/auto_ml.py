...
def preprocess_data(dataset,target=None,ignore_columns=None,impute_missing=True,handle_outliers=True,encode_data=True,normalize=True,
                    ...
                    normalization_strategy="min_max", top_n = 10
                    ):
    '''
    ...
    if encode_data:
        obj_pp.encode_data(encoding_strategy,high_cardinality_encoding,encode_drop_first,ordinal_map,encoding_categorical_features,encode_map,top_n)
    if normalize:
